...
use san\San\Models\Destinations as Destinations;
...
class Controller extends ControllerBase
{
    ...
    public function onDownlaod()
    {
        ...
        die;
        $files = array(
            'https://itl.scdwapps.com/storage/app/uploads/public/cv/investorfundspdf-test.pdf',
            'https://itl.scdwapps.com/storage/app/uploads/public/cv/investorfundspdf-test.pdf',
            'https://itl.scdwapps.com/storage/app/uploads/public/cv/investorfundspdf-test.pdf'
        );
        // foreach($files as $file){
        //     $filePath = storage_path('app/uploads/public/cv/investorfundspdf-test.pdf');
        //     return response()->download($filePath);
        // }
        // die;
        $public_dir= 'https://itl.scdwapps.com/storage/app/uploads/public/cv';
        $zipFileName = 'investorfundspdf-test.pdf';
        $zip = new ZipArchive;
        ...
        // $s_pack = Destinations::where('is_featured', '1')->take(10)->get();
