...
/**
 * MLSummerNote Form Widget
 */
class MLSummerNote extends FormWidgetBase
{
     ...
     * @inheritDoc
     */
    protected $defaultAlias = 'pkurg_posteditor_m_l_summer_note';
    ...
    {
        $this->prepareVars();
        return $this->makePartial('mlsummernote');
    }
