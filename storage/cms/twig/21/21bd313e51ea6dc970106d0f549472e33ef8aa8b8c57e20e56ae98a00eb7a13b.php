...
/* /Applications/MAMP/htdocs/itl/plugins/winter/pages/components/staticmenu/items.htm */
class __TwigTemplate_60a3ec71a8862ee41fc8667f886e098fd2a91d0b5a237e5fbb8d04ed4cf0fcbe extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ";
                ...
                if (twig_get_attribute($this->env, $this->source, $context["item"], "items", [], "any", false, false, true, 13)) {
                    ...
                    $context['__cms_partial_params']['sub'] = "1"                    ;
...
";
    ...
    {
        return "/Applications/MAMP/htdocs/itl/plugins/winter/pages/components/staticmenu/items.htm";
    }
    ...
    {
        return array (  100 => 16,  90 => 14,  88 => 13,  85 => 12,  79 => 10,  76 => 9,  72 => 8,  67 => 6,  60 => 5,  55 => 4,  53 => 3,  44 => 2,  39 => 1,);
    }
    ...
    <li role=\"presentation\" class=\"{{ item.isActive ? 'active' : '' }} {{ item.isChildActive ? 'child-active' : '' }} {{ item.viewBag.cssClass }}\">
        ...
        {% if item.items %}
            <ul>{% partial __SELF__ ~ \"::items\" items=item.items sub=\"1\" %}</ul>
        {% endif %}
    </li>
{% endfor %}", "/Applications/MAMP/htdocs/itl/plugins/winter/pages/components/staticmenu/items.htm", "");
    }
    
    public function checkSecurity()
    {
        static $tags = array("for" => 1, "if" => 3, "partial" => 14);
