; (function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
         ...
         * @returns {*|HTMLElement}
         */
        buildBaseDropdown: function (type, class_name) {
            var classString = class_name;
        ...
        buildDayDropdown: function () {
            var day,
                dropdown = this.buildBaseDropdown('day', 'form-control dob_field_data'),
        ...
        buildMonthDropdown: function () {
            var dropdown = this.buildBaseDropdown('month', 'form-control dob_field_data'),
                option = document.createElement('option');
        ...
        buildYearDropdown: function () {
            var minYear = this.config.minYear,
                ...
                dropdown = this.buildBaseDropdown('year', 'form-control dob_field_data'),
                option = document.createElement('option');
